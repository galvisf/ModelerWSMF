...
# Build the model
set outdir RSN6_IMPVALL.I_I-ELC180.AT2;
...
set filename "RSN6_IMPVALL.I_I-ELC180.AT2";  # GM filename
set scalor [expr 2.022];  # GM SF
set dt 0.01; # GM dt
set numpts 5375; # GM number of points
set serial 1;  # GM tag
set solvertag 1
