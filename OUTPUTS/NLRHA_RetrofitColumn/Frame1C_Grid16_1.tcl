...
set secInfo_i {1280.0000   1.0124   0.2000   0.0020   0.0024   0.0165   0.0000};
set secInfo_j {1280.0000   1.0124   0.2000   0.0020   0.0024   0.0165   0.0000};
...
hingeBeamColumn 1020100 4020104 4020202 "Horizontal" $trans_selected $n $Es $FyBeam $rigMatTag 89.000 [expr 19504.509*$Comp_I] $degradation $c $secInfo_i $secInfo_j $Composite $compBackboneFactors;
