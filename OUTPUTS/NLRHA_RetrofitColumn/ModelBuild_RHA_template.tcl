...
set indir "##GroundMotionFolderPath##";  # directory with input data
set filename "##GM_NAME##";  # GM filename
set scalor [expr ##SF##];  # GM SF
set dt ##dt##; # GM dt
set numpts ##numpts##; # GM number of points
set serial 1;  # GM tag
set solvertag 1
