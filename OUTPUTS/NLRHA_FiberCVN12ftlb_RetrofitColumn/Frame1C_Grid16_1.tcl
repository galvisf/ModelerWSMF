...
set FI_limB_bay1_floor2_i 1.138;	set FI_limT_bay1_floor2_i 1.497;	set FI_limB_bay1_floor2_j 0.582;	set FI_limT_bay1_floor2_j 1.209;	
set FI_limB_bay1_floor3_i 1.080;	set FI_limT_bay1_floor3_i 0.750;	set FI_limB_bay1_floor3_j 0.901;	set FI_limT_bay1_floor3_j 1.078;	
set FI_limB_bay1_floor4_i 2.360;	set FI_limT_bay1_floor4_i 1.839;	set FI_limB_bay1_floor4_j 0.723;	set FI_limT_bay1_floor4_j 1.950;	
...
# Panel zones floor2
ConstructPanel_Rectangle  1 2 $Axis1 $Floor2 $Es $A_Stiff $I_Stiff 19.60 37.30 $trans_selected;
ConstructPanel_Rectangle  2 2 $Axis2 $Floor2 $Es $A_Stiff $I_Stiff 19.60 37.30 $trans_selected;
...
# Panel zones floor2
PanelZoneSpring 9020100 4020109 4020110 $Es $mu $FyCol 19.60 17.00  3.50  2.19  2.75 37.30 8210.00 147.000 $SH_PZ 255.475 $trib $tslab $pzModelTag 1 $Composite;
PanelZoneSpring 9020200 4020209 4020210 $Es $mu $FyCol 19.60 17.00  3.50  2.19  2.75 37.30 8210.00 147.000 $SH_PZ 255.475 $trib $tslab $pzModelTag 1 $Composite;
# Panel zones floor3
...
set secInfo_i {1280.0000   1.1099   0.2000   0.0178   0.0016   0.0275   0.0000};
set secInfo_j {1280.0000   1.1099   0.2000   0.0178   0.0016   0.0275   0.0000};
...
set kBR 1.315
set kTR 1.158
hingeBeamColumnFracture 1020100 4020104 4020202 "Horizontal" $trans_selected $n $Es $FyBeam $rigMatTag 89.000 [expr 19504.509*$Comp_I] $degradation $c $secInfo_i $secInfo_j "Bolted" $fracSecGeometry $fracSecMaterials [expr $kBL*$sigCrB_bay1_floor2_i] [expr $kTL*$sigCrT_bay1_floor2_i] [expr $kBR*$sigCrB_bay1_floor2_j] [expr $kTR*$sigCrT_bay1_floor2_j] $FI_limB_bay1_floor2_i $FI_limT_bay1_floor2_i $FI_limB_bay1_floor2_j $FI_limT_bay1_floor2_j $Composite $compBackboneFactors $trib $tslab $bslab $AslabSteel $slabFiberMaterials;

# Beams at floor 3 bay 1
set secInfo_i {936.0000   1.1096   0.2000   0.0180   0.0016   0.0277   0.0000};
set secInfo_j {936.0000   1.1096   0.2000   0.0180   0.0016   0.0277   0.0000};
set compBackboneFactors [lreplace $compBackboneFactors 0 0   1.0000];# MpP/Mp
set compBackboneFactors [lreplace $compBackboneFactors 1 1   1.0000];# MpN/Mp
...
set secInfo_i {163.0825   1.1555   0.2000   0.0307   0.0023   0.0446   0.0000};
set secInfo_j {163.0825   1.1555   0.2000   0.0307   0.0023   0.0446   0.0000};
set compBackboneFactors [lreplace $compBackboneFactors 0 0   1.0000];# MpP/Mp
set compBackboneFactors [lreplace $compBackboneFactors 1 1   1.0000];# MpN/Mp
...
set secInfo_i {1011.4203   1.3265   0.8669   0.0801   0.0683   0.1712   0.0000};
set secInfo_j {1011.4203   1.3265   0.8669   0.0801   0.0683   0.1712   0.0000};
hingeBeamColumn 2010100 10100 4020101 "Vertical" $trans_selected $n $Es $FyCol $rigMatTag 147.000 7669.753 $degradation $c $secInfo_i $secInfo_j 0 0;
...
set secInfo_i {1011.4203   1.3265   0.8669   0.0801   0.0683   0.1712   0.0000};
set secInfo_j {1011.4203   1.3265   0.8669   0.0801   0.0683   0.1712   0.0000};
hingeBeamColumn 2010200 10200 4020201 "Vertical" $trans_selected $n $Es $FyCol $rigMatTag 147.000 7669.753 $degradation $c $secInfo_i $secInfo_j 0 0;
...
pattern Plain 101 Linear {
	...
	# Floor 2
	eleLoad -ele 1020100 -type -beamUniform   -0.19389; # Beam at floor 2 bay 1
	# Floor 3
