...
# Build the model
set outdir RSN96_MANAGUA_B-ESO090.AT2;
...
set filename "RSN96_MANAGUA_B-ESO090.AT2";  # GM filename
set scalor [expr 2.744];  # GM SF
set dt 0.005; # GM dt
set numpts 9580; # GM number of points
set serial 1;  # GM tag
set solvertag 1
