...
# Build the model
set outdir RSN40_BORREGO_A-SON033.AT2;
...
set filename "RSN40_BORREGO_A-SON033.AT2";  # GM filename
set scalor [expr 16.396];  # GM SF
set dt 0.005; # GM dt
set numpts 9045; # GM number of points
set serial 1;  # GM tag
set solvertag 1
