...
set ttab 0.645
set dtab 8.848
set spliceSecGeometry { 14.7000  14.7000   1.0300   0.6450 };
hingeBeamColumnSpliceZLS 2030100 4030103 4040101 "Vertical" $trans_selected $n $Es $FyCol $rigMatTag 38.800 1341.808 $degradation $c $secInfo_i $secInfo_j $spliceLoc $spliceSecGeometry $FyCol $sigCr $ttab $dtab;
...
set dtab 8.848
set spliceSecGeometry { 14.7000  14.7000   1.0300   0.6450 };
hingeBeamColumnSpliceZLS 2030200 4030203 4040201 "Vertical" $trans_selected $n $Es $FyCol $rigMatTag 38.800 1341.808 $degradation $c $secInfo_i $secInfo_j $spliceLoc $spliceSecGeometry $FyCol $sigCr $ttab $dtab;
...
set dtab 8.848
set spliceSecGeometry { 14.7000  14.7000   1.0300   0.6450 };
hingeBeamColumnSpliceZLS 2030300 4030303 4040301 "Vertical" $trans_selected $n $Es $FyCol $rigMatTag 38.800 1341.808 $degradation $c $secInfo_i $secInfo_j $spliceLoc $spliceSecGeometry $FyCol $sigCr $ttab $dtab;
...
set dtab 8.848
set spliceSecGeometry { 14.7000  14.7000   1.0300   0.6450 };
hingeBeamColumnSpliceZLS 2030400 4030403 4040401 "Vertical" $trans_selected $n $Es $FyCol $rigMatTag 38.800 1341.808 $degradation $c $secInfo_i $secInfo_j $spliceLoc $spliceSecGeometry $FyCol $sigCr $ttab $dtab;
...
set dtab 8.848
set spliceSecGeometry { 14.7000  14.7000   1.0300   0.6450 };
hingeBeamColumnSpliceZLS 2030500 4030503 4040501 "Vertical" $trans_selected $n $Es $FyCol $rigMatTag 38.800 1341.808 $degradation $c $secInfo_i $secInfo_j $spliceLoc $spliceSecGeometry $FyCol $sigCr $ttab $dtab;
...
region 2 -ele 2010100 2020100 2030100 2040100 2010200 2020200 2030200 2040200 2010300 2020300 2030300 2040300 2010400 2020400 2030400 2040400 2010500 2020500 2030500 2040500 2030102 2030202 2030302 2030402 2030502 -rayleigh 0.0 0.0 $a1_mod 0.0;

# Hinge elements [beam springs, column springs]
region 3 -ele 1020101 1020102 1020201 1020202 1020301 1020302 1020401 1020402 1030101 1030102 1030201 1030202 1030301 1030302 1030401 1030402 1040101 1040102 1040201 1040202 1040301 1040302 1040401 1040402 1050101 1050102 1050201 1050202 1050301 1050302 1050401 1050402 2010101 2010102 2010201 2010202 2010301 2010302 2010401 2010402 2010501 2010502 2020101 2020102 2020201 2020202 2020301 2020302 2020401 2020402 2020501 2020502 2040101 2040102 2040201 2040202 2040301 2040302 2040401 2040402 2040501 2040502 -rayleigh 0.0 0.0 [expr $a1_mod/$n] 0.0;
...
if {$addBasicRecorders == 1} {
	...
	recorder Element -file $outdir/ss_splice.out -dT 0.01 -ele 2030105 2030205 2030305 2030405 2030505 section fiber 0 stressStrain;

	recorder Element -file $outdir/def_splice.out -dT 0.01 -ele 2030105 2030205 2030305 2030405 2030505  deformation;

	recorder Element -file $outdir/force_splice.out -dT 0.01 -ele 2030105 2030205 2030305 2030405 2030505  localForce;
...
if {$addBasicRecorders == 1} {
	...
	# Bottom
	recorder Element -file $outdir/hinge_bot.out -dT 0.01 -ele 2030103 2030203 2030303 2030403 2030503 2010101 2010201 2010301 2010401 2010501 2020101 2020201 2020301 2020401 2020501 2040101 2040201 2040301 2040401 2040501 deformation;
	# Top
	recorder Element -file $outdir/hinge_top.out -dT 0.01 -ele 2030104 2030204 2030304 2030404 2030504 2010102 2010202 2010302 2010402 2010502 2020102 2020202 2020302 2020402 2020502 2040102 2040202 2040302 2040402 2040502 deformation;
}

if {$addDetailedRecorders == 1} {

	# Bottom
	recorder Element -file $outdir/hinge_bot_force.out -dT 0.01 -ele 2030103 2030203 2030303 2030403 2030503 2010101 2010201 2010301 2010401 2010501 2020101 2020201 2020301 2020401 2020501 2040101 2040201 2040301 2040401 2040501 force;
	# Top
	recorder Element -file $outdir/hinge_top_force.out -dT 0.01 -ele 2030104 2030204 2030304 2030404 2030504 2010102 2010202 2010302 2010402 2010502 2020102 2020202 2020302 2020402 2020502 2040102 2040202 2040302 2040402 2040502 force;
}
