...
set secInfo_i {1280.0000   1.0133   0.2000   0.0016   0.0087   0.0132   0.0000};
set secInfo_j {1280.0000   1.0133   0.2000   0.0016   0.0087   0.0132   0.0000};
...
set secInfo_i {936.0000   1.0145   0.2000   0.0022   0.0108   0.0166   0.0000};
set secInfo_j {936.0000   1.0145   0.2000   0.0022   0.0108   0.0166   0.0000};
set compBackboneFactors [lreplace $compBackboneFactors 0 0   1.0000];# MpP/Mp
set compBackboneFactors [lreplace $compBackboneFactors 1 1   1.0000];# MpN/Mp
...
set secInfo_i {175.3136   1.0809   0.2000   0.0159   0.0052   0.0229   0.0000};
set secInfo_j {175.3136   1.0809   0.2000   0.0159   0.0052   0.0229   0.0000};
set compBackboneFactors [lreplace $compBackboneFactors 0 0   1.0000];# MpP/Mp
set compBackboneFactors [lreplace $compBackboneFactors 1 1   1.0000];# MpN/Mp
...
if {$addBasicRecorders == 1} {
	...
	# Left
	recorder Element -file $outdir/hinge_left.out -closeOnWrite -precision 16 -ele 1020101 1030101 1040101 deformation;

	# Right
	recorder Element -file $outdir/hinge_right.out -closeOnWrite -precision 16 -ele 1020102 1030102 1040102 deformation;
}

if {$addDetailedRecorders == 1} {

	recorder Element -file $outdir/hinge_right_force.out -closeOnWrite -precision 16 -ele 1020102 1030102 1040102 force;

	recorder Element -file $outdir/hinge_left_force.out -closeOnWrite -precision 16 -ele 1020101 1030101 1040101 force;
}
