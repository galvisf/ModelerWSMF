...
set dy [expr $fy/($Es*$A)]
set du [expr 0.10]
uniaxialMaterial Hysteretic $braceMatTag $fy $dy [expr 1.1*$fy] $du [expr 0.0*$fy] [expr 2*$du] [expr -0.05*$fy] [expr -0.05*$dy] [expr -0.05*$fy] [expr -$du/2] 0.0 [expr -$du] 1.00 1.00 0.00 0.00	
