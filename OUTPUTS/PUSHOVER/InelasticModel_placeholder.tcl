...
set FI_limB_bay1_floor2_i 2.010;	set FI_limT_bay1_floor2_i 1.199;	set FI_limB_bay1_floor2_j 1.392;	set FI_limT_bay1_floor2_j 0.792;	
set FI_limB_bay1_floor3_i 0.894;	set FI_limT_bay1_floor3_i 0.942;	set FI_limB_bay1_floor3_j 1.302;	set FI_limT_bay1_floor3_j 0.941;	
set FI_limB_bay1_floor4_i 1.183;	set FI_limT_bay1_floor4_i 0.637;	set FI_limB_bay1_floor4_j 0.919;	set FI_limT_bay1_floor4_j 0.834;	

# CVN PER FLANGE AND CONNECTION
# Left connection               Right connection
set cvn_bay1_floor2_i 8.000;	set cvn_bay1_floor2_j 8.000;	
set cvn_bay1_floor3_i 8.000;	set cvn_bay1_floor3_j 8.000;	
set cvn_bay1_floor4_i 8.000;	set cvn_bay1_floor4_j 8.000;	
...
set secInfo_i {1280.0000   1.1177   0.2000   0.0142   0.0058   0.0220   0.0000};
set secInfo_j {1280.0000   1.1177   0.2000   0.0142   0.0058   0.0220   0.0000};
...
set secInfo_i {936.0000   1.1178   0.2000   0.0180   0.0073   0.0277   0.0000};
set secInfo_j {936.0000   1.1178   0.2000   0.0180   0.0073   0.0277   0.0000};
set compBackboneFactors [lreplace $compBackboneFactors 0 0   1.0000];# MpP/Mp
set compBackboneFactors [lreplace $compBackboneFactors 1 1   1.0000];# MpN/Mp
...
set secInfo_i {175.3136   1.1555   0.2000   0.0307   0.0105   0.0446   0.0000};
set secInfo_j {175.3136   1.1555   0.2000   0.0307   0.0105   0.0446   0.0000};
set compBackboneFactors [lreplace $compBackboneFactors 0 0   1.0000];# MpP/Mp
set compBackboneFactors [lreplace $compBackboneFactors 1 1   1.0000];# MpN/Mp
...
set secInfo_i {761.2495   1.2924   0.8553   0.0686   0.0602   0.1488   0.0000};
set secInfo_j {761.2495   1.2924   0.8553   0.0686   0.0602   0.1488   0.0000};
...
set secInfo_i {775.2841   1.3453   0.8711   0.0753   0.0673   0.1651   0.0000};
set secInfo_j {775.2841   1.3453   0.8711   0.0753   0.0673   0.1651   0.0000};
...
set secInfo_i {792.2284   1.1801   0.8901   0.0614   0.0514   0.1299   0.0000};
set secInfo_j {792.2284   1.1801   0.8901   0.0614   0.0514   0.1299   0.0000};
...
if {$addBasicRecorders == 1} {
	...
	# Left-bottom flange
	recorder Element -file $outdir/frac_LB.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 7 failure;

	# Left-top flange
	recorder Element -file $outdir/frac_LT.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 2 failure;

	# Right-bottom flange
	recorder Element -file $outdir/frac_RB.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 7 failure;

	# Right-top flange
	recorder Element -file $outdir/frac_RT.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 2 failure;

	# Recorders for beam fracture index
	# Left-bottom flange
	recorder Element -file $outdir/FI_LB.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 7 damage;

	# Left-top flange
	recorder Element -file $outdir/FI_LT.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 2 damage;

	# Right-bottom flange
	recorder Element -file $outdir/FI_RB.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 7 damage;

	# Right-top flange
	recorder Element -file $outdir/FI_RT.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 2 damage;
...
if {$addDetailedRecorders == 1} {
	...
	# Recorders for beam fracture index
	# Left-bottom flange
	recorder Element -file $outdir/ss_LB.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 7 stressStrain;

	# Left-top flange
	recorder Element -file $outdir/ss_LT.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 2 stressStrain;

	# Right-bottom flange
	recorder Element -file $outdir/ss_RB.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 7 stressStrain;

	# Right-top flange
	recorder Element -file $outdir/ss_RT.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 2 stressStrain;

	# Recorders for slab fiber stressStrain

	# Left-Concrete
	recorder Element -file $outdir/slabComp_L.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 10 stressStrain;

	# Left-Steel
	recorder Element -file $outdir/slabTen_L.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 11 stressStrain;

	# Right-Concrete
	recorder Element -file $outdir/slabComp_R.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 10 stressStrain;

	# Right-Steel
	recorder Element -file $outdir/slabTen_R.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 11 stressStrain;

	# Recorders for web fibers

	# Left-web1
	recorder Element -file $outdir/webfiber_L1.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 12 stressStrain;

	# Left-web2
	recorder Element -file $outdir/webfiber_L2.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 13 stressStrain;

	# Left-web3
	recorder Element -file $outdir/webfiber_L3.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 14 stressStrain;


	# Left-web4
	recorder Element -file $outdir/webfiber_L4.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section fiber 15 stressStrain;


	# Right-web1
	recorder Element -file $outdir/webfiber_R1.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 12 stressStrain;

	# Right-web2
	recorder Element -file $outdir/webfiber_R2.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 13 stressStrain;

	# Right-web3
	recorder Element -file $outdir/webfiber_R3.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 14 stressStrain;


	# Right-web4
	recorder Element -file $outdir/webfiber_R4.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section fiber 15 stressStrain;

	# Recorders beam fiber-section element

	# Left
	recorder Element -file $outdir/def_left.out -closeOnWrite -precision 16 -ele 1020105 1030105 1040105 section deformation;

	# Right
	recorder Element -file $outdir/def_right.out -closeOnWrite -precision 16 -ele 1020106 1030106 1040106 section deformation;
...
if {$addBasicRecorders == 1} {
	...
	# Left
	recorder Element -file $outdir/hinge_left.out -closeOnWrite -precision 16 -ele 1020102 1030102 1040102 deformation;

	# Right
	recorder Element -file $outdir/hinge_right.out -closeOnWrite -precision 16 -ele 1020104 1030104 1040104 deformation;
}

if {$addDetailedRecorders == 1} {

	recorder Element -file $outdir/hinge_right_force.out -closeOnWrite -precision 16 -ele 1020104 1030104 1040104 force;

	recorder Element -file $outdir/hinge_left_force.out -closeOnWrite -precision 16 -ele 1020102 1030102 1040102 force;
}
...
if {$addBasicRecorders == 1} {
	...
	# Bottom
	recorder Element -file $outdir/hinge_bot.out -closeOnWrite -precision 8 -ele 2010101 2020101 2030101 2010201 2020201 2030201 deformation;
	# Top
	recorder Element -file $outdir/hinge_top.out -closeOnWrite -precision 8 -ele 2010102 2020102 2030102 2010202 2020202 2030202 deformation;
}

if {$addDetailedRecorders == 1} {

	# Bottom
	recorder Element -file $outdir/hinge_bot_force.out -closeOnWrite -precision 8 -ele 2010101 2020101 2030101 2010201 2020201 2030201 force;
	# Top
	recorder Element -file $outdir/hinge_top_force.out -closeOnWrite -precision 8 -ele 2010102 2020102 2030102 2010202 2020202 2030202 force;
}
