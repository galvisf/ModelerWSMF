...
%                         fprintf(INP, 'elasticBeamColumnSpliceFiber %d %d %d "Vertical" $trans_selected $Es $rigMatTag %.3f %.3f $spliceLoc $spliceSecGeometry $ttab $dtab;\n', ...
%                             ElementID, node_i, node_j, mean([A_i, A_j]), Ieff);
                        
                        
                        fprintf(INP, 'elasticBeamColumnSplice %d %d %d "Vertical" $trans_selected $Es $rigMatTag %.3f %.3f $spliceLoc;\n', ...
                            ElementID, node_i, node_j, mean([A_i, A_j]), Ieff);
