...
proc hingeBeamColumnFracture { eleTag node1 node2 eleDir transfTag n Es Fy rigMatTag A Ieff degradation c secInfo_i secInfo_j webConnection fracSecGeometry fracSecMaterials sigCrB_i sigCrT_i sigCrB_j sigCrT_j FI_limB_i FI_limT_i FI_limB_j FI_limT_j Composite compBackboneFactors trib tslab bslab AslabSteel slabFiberMaterials} {
	...
	uniaxialMaterial SteelFractureDI $topFMatTag_i $FyFiber $FyFiber $EsFiber 0.02 18 0.85 0.15 0.08 1.00 0.08 1.00 $sigCrT_i $betaC_T $sigMin $FI_limT_i;
	...
	uniaxialMaterial SteelFractureDI $topFMatTag_j $FyFiber $FyFiber $EsFiber 0.02 18 0.85 0.15 0.08 1.00 0.08 1.00 $sigCrT_j $betaC_T $sigMin $FI_limT_j;
	...
	if {$webConnection == "Bolted"} {	
		...
		fracSectionBolted $fracSecTag_i $eleDir $topFMatTag_i $botFMatTag_i $webMatTag_i $d $bf $tf $ttab $boltLocation $boltDiameter $FuBolt $FyTab $FuTab $Lc $tabLength $du_div $Composite $slabMatTag  $trib $tslab $AslabFiber;
		fracSectionBolted $fracSecTag_j $eleDir $topFMatTag_j $botFMatTag_j $webMatTag_j $d $bf $tf $ttab $boltLocation $boltDiameter $FuBolt $FyTab $FuTab $Lc $tabLength $du_div $Composite $slabMatTag  $trib $tslab $AslabFiber;
		
	} else {
		# Fully welded web connection		
		fracSectionWelded $fracSecTag_i $eleDir $topFMatTag_i $botFMatTag_i $webMatTag_i $d $bf $tf $ttab $dtab $FyTab $FuTab $EsFiber $Composite $slabMatTag $trib $tslab $AslabFiber;
		fracSectionWelded $fracSecTag_j $eleDir $topFMatTag_j $botFMatTag_j $webMatTag_j $d $bf $tf $ttab $dtab $FyTab $FuTab $EsFiber $Composite $slabMatTag $trib $tslab $AslabFiber;
